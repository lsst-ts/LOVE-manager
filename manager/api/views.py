...
def ole_send_night_report(request, *args, **kwargs):
    ...
    # Set time cut for EFD queries. If the report is for a past obs day,
    # we set the cut to the end of that obs day
    report_obsday_end_tai = get_obsday_end_to_tai(last_valid_report_obsday)
