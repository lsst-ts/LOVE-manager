    ...
    def save(self, *args, **kwargs):
        if self.selected:
            ...
            if not kwargs["request"].user.is_superuser:
                raise ValidationError("Only administrators can select a control location.")
...
class ScriptConfiguration(models.Model):
    ...
    script_type = models.CharField(max_length=10, choices=ScriptTypes.choices, default=None)
