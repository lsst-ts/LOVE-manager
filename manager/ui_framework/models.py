...
class BaseModel(models.Model):
    ...
    creation_timestamp = models.DateTimeField(auto_now_add=True, editable=False, verbose_name="Creation time")
    """Creation timestamp, autogenerated upon creation"""

    update_timestamp = models.DateTimeField(auto_now=True, editable=False, verbose_name="Last Updated")
...
class OverwriteStorage(FileSystemStorage):
    def get_available_name(self, name, max_length):
        ...
        max_length : int
            ...
            (currently unused but needed to match the expected API)
...
class View(BaseModel):
    ...
    thumbnail = models.ImageField(max_length=200, upload_to="thumbnails/", null=True, blank=True)
...
class Workspace(BaseModel):
    ...
    def get_sorted_views(self):
        """Return the views sorted by the sort_value
        of their corresponding WorkView.
    ...
    def has_read_permission(request):
        """Check if the given user has read permissions
        over Workspace objects
        ...
        -------
        bool
            True if request.user has read permissions
            over Workspace objects, False if not
        """
