...
def parse_observatory_status_to_plain_text(observatory_status):
    ...
    plain_text += f"el = {observatory_status['simonyiAzimuth']}{maintel_params_units['simonyiAzimuth']}, "
    plain_text += f"az = {observatory_status['simonyiElevation']}{maintel_params_units['simonyiElevation']}, "
    plain_text += (
    ...
    plain_text += f"el = {observatory_status['auxtelAzimuth']}{auxtel_params_units['auxtelAzimuth']}, "
    plain_text += f"az = {observatory_status['auxtelElevation']}{auxtel_params_units['auxtelElevation']}, "
    plain_text += (
