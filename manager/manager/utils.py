...
from manager.settings import NIGHTLYDIGEST_BASE_URL
...
def arrange_nightlydigest_urls_for_obsday(obsday):
    ...
    return {
        "simonyi": f"{NIGHTLYDIGEST_BASE_URL}/?startDayobs={obsday}&endDayobs={obsday}&telescope=Simonyi",
        "auxtel": f"{NIGHTLYDIGEST_BASE_URL}/?startDayobs={obsday}&endDayobs={obsday}&telescope=AuxTel",
    }
